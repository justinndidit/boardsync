...
public class BoardSyncDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<WorkItem>(entity =>
        {
            ...
            /*
             * Generated by Postgres from title and description, with a GIN index over it.
             *
             * `english` rather than `simple`: it stems, so "migrating" finds "migrate", which is how
             * people actually remember what they wrote. The cost is that it is one language — a
             * limitation worth knowing rather than discovering.
             */
            entity.HasGeneratedTsVectorColumn(
                    w => w.SearchVector,
                    "english",
                    w => new { w.Title, w.Description })
